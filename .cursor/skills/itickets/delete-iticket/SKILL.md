...
In `.scratch/.itickets/<itag>`, delete any `.md` file whose `github-issue:` line matches the issue number or URL per the [matching rule](skills/itickets/ITICKET-FORMAT.md#matching-rule).
